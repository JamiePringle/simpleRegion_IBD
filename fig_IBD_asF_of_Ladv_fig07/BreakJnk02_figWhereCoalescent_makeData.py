...
if __name__=='__main__':
    ...
    for loopParam in [100,200,400]:
        ...
        nPatch=5; Np=1024; dOff=loopParam; dOffInit=50
        runName='largeDomain_Ladv_dOff_%d_dOffInit_%d_Ldiff_%d_nPatch_%d'%(dOff,dOffInit,param2,nPatch);  
        ...
        for param1 in param1vec:
            ...
            if True:
                ...
                dictToSave={'answerVec':answerVec,'startPoints':startPoints,'param1vec':param1vec,'param1name':param1name,
                            ...
                            'param2name':param2name,'dOffInit':dOffInit}
